...
public class WuliugongsiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		wuliugongsi.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,WuliugongsiEntity wuliugongsi, HttpServletRequest request,String pre){
        EntityWrapper<WuliugongsiEntity> ew = new EntityWrapper<WuliugongsiEntity>();
