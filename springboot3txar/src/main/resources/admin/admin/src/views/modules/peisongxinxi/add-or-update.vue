	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="配送时间" prop="peisongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.peisongshijian" label="配送时间" prop="peisongshijian">
					<el-input v-model="ruleForm.peisongshijian" placeholder="配送时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="配送员" prop="peisongyuan">
					<el-select :disabled="ro.peisongyuan" @change="peisongyuanChange" v-model="ruleForm.peisongyuan" placeholder="请选择配送员">
						<el-option
							v-for="(item,index) in peisongyuanOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.peisongyuan" label="配送员" prop="peisongyuan">
					<el-input v-model="ruleForm.peisongyuan" placeholder="配送员" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="运输路线1" prop="yunshuluxian">
					<el-input v-model="ruleForm.yunshuluxian" placeholder="运输路线1" clearable  :readonly="ro.yunshuluxian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="运输路线1" prop="yunshuluxian">
					<el-input v-model="ruleForm.yunshuluxian" placeholder="运输路线1" readonly></el-input>
				</el-form-item>
			</template>
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.peisongyuanOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
			...
			peisongyuanChange () {
				this.$http({
					url: `follow/yuangong/yuangonggonghao?columnValue=`+ this.ruleForm.peisongyuan,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
