	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="收货账号" prop="shouhuozhanghao">
					<el-select :disabled="ro.shouhuozhanghao" v-model="ruleForm.shouhuozhanghao" placeholder="请选择收货账号" >
						<el-option
							v-for="(item,index) in shouhuozhanghaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="收货账号" prop="shouhuozhanghao">
					<el-input v-model="ruleForm.shouhuozhanghao"
						placeholder="收货账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="收货姓名" prop="shouhuoxingming">
					<el-select :disabled="ro.shouhuoxingming" v-model="ruleForm.shouhuoxingming" placeholder="请选择收货姓名" >
						<el-option
							v-for="(item,index) in shouhuoxingmingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="收货姓名" prop="shouhuoxingming">
					<el-input v-model="ruleForm.shouhuoxingming"
						placeholder="收货姓名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="收货日期" prop="shouhuoriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.shouhuoriqi" 
						type="date"
						:readonly="ro.shouhuoriqi"
						placeholder="收货日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shouhuoriqi" label="收货日期" prop="shouhuoriqi">
					<el-input v-model="ruleForm.shouhuoriqi" placeholder="收货日期" readonly></el-input>
				</el-form-item>
			</template>
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.shouhuozhanghaoOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
            this.$http({
				...
				if (data && data.code === 0) {
					this.shouhuoxingmingOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
