	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="运输员" prop="yunshuyuan">
					<el-select :disabled="ro.yunshuyuan" @change="yunshuyuanChange" v-model="ruleForm.yunshuyuan" placeholder="请选择运输员">
						<el-option
							v-for="(item,index) in yunshuyuanOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yunshuyuan" label="运输员" prop="yunshuyuan">
					<el-input v-model="ruleForm.yunshuyuan" placeholder="运输员" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="运输路线2" prop="yunshuluxian">
					<el-input v-model="ruleForm.yunshuluxian" placeholder="运输路线2" clearable  :readonly="ro.yunshuluxian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="运输路线2" prop="yunshuluxian">
					<el-input v-model="ruleForm.yunshuluxian" placeholder="运输路线2" readonly></el-input>
				</el-form-item>
			</template>
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.yunshuyuanOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
			...
			yunshuyuanChange () {
				this.$http({
					url: `follow/yuangong/yuangonggonghao?columnValue=`+ this.ruleForm.yunshuyuan,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
